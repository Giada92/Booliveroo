...
<div>
    <div class="container-fluid bg">
        ...
        <div class="d-flex flex-wrap">
            <div class="col-sm-12 col-md-4 col-lg-3 offset-lg-1 aside">
                <div>
                    <a href="#la-storia">La storia di Booliveroo</a>
                </div>
                <div>
                    <a href="#i-valori">I nostri valori</a>
                </div>
                <div>
                    <a href="#clienti">Clienti</a>
                </div>
                <div>
                    <a href="#tecnologia">E' la tecnologia che ci guida</a> 
                </div>
                <div>
                    <a href="#rider">Booliveroo e i nostri rider</a>
                </div>
                <div>
                    <a href="#ristorante">I ristoranti migliori, consegnati dove vuoi</a>
                </div>
            </div>
            <div class="col-sm-12 col-md-7 main">
                ...
                <div>
                    ...
                    <img src="/img/valori-aziendali.jpg" alt="valori-aziendali">
                    <p id="clienti">
                        Tutto ciò che facciamo ruota intorno ai nostri valori. Ci fanno da guida ogni giorno per lavorare in squadra e prendere decisioni importanti, dalle scelte che hanno un impatto sulle assunzioni e sullo sviluppo del personale, a quelle che scrivono il futuro dei prodotti Booliveroo.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <img src="/img/clienti.jpg" alt="clienti">
                    <p>
                ...
                <div>
                    ...
                    <img src="/img/riders.png" alt="riders">
                    <p>
